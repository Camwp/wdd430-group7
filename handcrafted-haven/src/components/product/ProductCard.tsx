...
export default function ProductCard({ id, title, priceCents, image, rating, reviews }: Props) {
    ...
    return (
        ...
        >
            <div className="aspect-[4/5] bg-neutral-100">
                {/* Using img keeps setup simple; swap to next/image later if desired */}
            ...
            <div className="p-3">
                ...
                <div className="mt-1 text-sm text-neutral-600">
                    {typeof rating === "number" ? `★ ${rating.toFixed(1)} (${reviews ?? 0})` : "No ratings yet"}
                </div>
